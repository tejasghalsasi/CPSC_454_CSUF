...
import scheduler.BasicFIFOScheduler;
...
public abstract class JobOptimizer {
	...
	public static final String JOB_OPT_TYPE = "opensimplex.job.optimizer.type";
	public static final String JOB_OPT_EXCLUDE_PARAMS = "opensimplex.job.optimizer.exclude.parameters";
	public static final String JOB_OPT_OUTPUT = "opensimplex.job.optimizer.output";
	public static final String JOB_OPT_MODE = "opensimplex.job.optimizer.mode";
	public static final String JOB_OPT_PROFILE_ID = "opensimplex.job.optimizer.profile.id";
	public static final String JOB_OPT_SCHEDULER = "opensimplex.whatif.task.scheduler";
	...
	/**
	 * Asks the Hadoop Engine to find the running time of the job with this
	 * configuration
	 * 
	 * @param conf
	...
	public static void copyOptimalConfSettings(Configuration bestConf,
		...
		if (conf.get(MR_COMBINE_CLASS) != null
				&& conf.getBoolean(opensimplex_USE_COMBINER, true) == false) {
	 ...
	 * settings.
	 * 
	 * Note: The Hadoop parameter 'opensimplex.job.optimizer.type' should contain
	 ...
	 * 
	 * Note: The Hadoop parameter 'opensimplex.job.optimizer.type' should contain
	 * the type of the optimizer to use: rrs, smart_rrs.
	 * 
	 * @param job
	 *            the MapReduce job
	 * @param jobProfileId
	 ...
	 * 
	 * @param type
	 *            the optimizer type (full, smart_full)
	 * @param jobOracle
	 *            the job profile oracle
	 * @param dataModel
	 *            the data model
	 ...
	 * configuration setting "opensimplex.job.optimizer.output"
	 * 
	 * @param conf
	 *            the configuration
